 ...
 * suite.
 *
 * It quietly handles runner size filter annotations and old platform size annotations.
 */
public final class TestSize {

    /**
     * @see android.support.test.filters.SmallTest
     */
    public static final TestSize SMALL = new TestSize("small",
            android.support.test.filters.SmallTest.class,
            android.test.suitebuilder.annotation.SmallTest.class, 200 /* in ms */);

    /**
     * @see android.support.test.filters.MediumTest
     */
    public static final TestSize MEDIUM = new TestSize("medium",
            android.support.test.filters.MediumTest.class,
            android.test.suitebuilder.annotation.MediumTest.class, 1000  /* in ms */);

    /**
     * @see android.support.test.filters.LargeTest
     */
    public static final TestSize LARGE = new TestSize("large",
    ...
    private static final Set<TestSize> ALL_SIZES = Collections.unmodifiableSet(new
            HashSet<>(Arrays.asList(SMALL, MEDIUM, LARGE)));
    ...
    /**
     * This value the maximum allowed runtime (in ms) for a test included in the test size suite.
     * It is used to make an educated guess at which size bucket a test belongs to.
     */
    private final float mTestSizeRunTimeThreshold;

    @VisibleForTesting
    public TestSize(String sizeQualifierName, Class<? extends Annotation> platformAnnotationClass,
    ...
    /**
     * Creates a test size instance from a test size string. This method will return
     * {@link TestSize#NONE} if the test size is unknown.
     */
    ...
    /**
     * Creates a test size instance from a {@link Description}. This method will return
     * {@link TestSize#NONE} if the description does not contain any test size information.
     */
